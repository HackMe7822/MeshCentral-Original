                    ...
                    if (_cmd === 'start' && !_s._audioActive) {
                        var _doWasapiInit = function() { try {
                            ...
                            var _runSapi = function(samples) {
                                ...
                                try{_s.write('TEXT:[CC-v54 seq='+seq+']');}catch(_e){}
                                var _sttExe = require('os').tmpdir()+'\\mesh_stt.exe';
                                ...
                                try { _ch = require('child_process').execFile(_sttExe,[wavPath],{timeout:35000}); }
                                    ...
                                    _sapiRunning=false;
                                    try{_s.write('TEXT:[STT-LAUNCH-ERR:'+_ce.message+']');}catch(_){}
                                    return;
                                }
